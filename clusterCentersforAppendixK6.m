...
tileIndex = 2;
% Inside your nested loop
for svar1 = 1:4
    for svar2 = svar1+1:5
        nexttile(tileIndex);
        
        % Increment tileIndex and skip 4th tile as per your logic
        ...
        % Add labels only for specific figures
        if tileIndex == 3 || tileIndex == 6 || tileIndex == 10
