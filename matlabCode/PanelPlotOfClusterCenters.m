...
for svar1 = 1:4
    ...
    % 
     ...
     'MarkerFaceAlpha', viridis_transparencies(svar2)/2, 'MarkerEdgeColor', 'none');
        ...
        hold on;
        scatter3(fairCenters{svar1,svar2}(:,1), fairCenters{svar1,svar2}(:,2), fairCenters{svar1,svar2}(:,3),1.3*S_ctr, colors(7,:), 'filled', 'MarkerFaceAlpha', 1.0, 'MarkerEdgeColor', 'k', 'LineWidth',1)
        hold on;
