...
for svar2 = svar2_combinations
    ...
    meanUnfairCenters = cell(4,5);
    meanUnfairCenters{1} = unfairCenters{svar1, svar2}(1, :);
    meanUnfairCenters{2} = mean(unfairCenters{svar1, svar2}(2:3, :));
    meanUnfairCenters{3} = mean(unfairCenters{svar1, svar2}(4:6, :));
...
exportgraphics(gcf,['ClusterCentersK6','.tif',],'Resolution',300)
